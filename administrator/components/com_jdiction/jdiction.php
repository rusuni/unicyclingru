...
// Access check.
if (!JFactory::getUser()->authorise('core.manage', 'com_jdiction')) {
...
$controller	= JControllerLegacy::getInstance('jDiction');
$controller->execute(JFactory::getApplication()->input->get('task', null, 'cmd'));
$controller->redirect();
