 ...
 * @package		jDiction
 */
class jDictionViewExport extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $state;
    ...
    JFactory::getApplication()->input->set('hidemainmenu', true);
		...
		JToolBarHelper::title(JText::_('COM_JDICTION_EXPORT'), 'jdiction-export');

		// If an existing item, can save to a copy.
		if ($canDo->get('core.create')) {
			JToolBarHelper::custom('tools.export', 'save.png', 'save_f2.png', 'COM_JDICTION_DOWNLOAD', false);
		}
