	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand poz" href="<?php echo JURI::root(); ?>index.php?tp=1" title="<?php echo JText::_('TPL_ISIS_POSITION');?> <?php echo $sitename; ?>" target="_blank"><?php echo JText::_('TPL_ISIS_POSITION');?> <i class="icon-out-2 small"></i></a>
				<?php if ($this->params->get('admin_menus') != '0') : ?>
