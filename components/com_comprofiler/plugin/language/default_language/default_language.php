...
DEFINE('_UE_REGISTER','New account');
...
//Beta 3 Build
DEFINE('_UE_NOLISTFOUND','Please, register to use this feature!');
...
DEFINE('_UE_LOST_USERNAME_PASSWORD','Forgot login-pass?');
DEFINE('_UE_LOST_USERNAME_OR_PASSWORD','Oh. Fortunately, we never need a log-pass pair to ride a unicycle.');
...
DEFINE('_UE_LOST_USERNAME_ONLY_DESC','Please enter your @-address, then click the Make me happy button, and your username will be sent to your email address.');
DEFINE('_UE_LOST_PASSWORD_DESC','Please enter your Username and your @-address, press the Generate button, and you will receive a new password shortly.');
DEFINE('_UE_LOST_USERNAME_PASSWORD_DESC','No problem. Recover your username first, and then generate a new password here. Please enter your @-address below, then click the Recover me, please! button, and your username will be sent to your @-address. From there use this form to generate your new password.');
DEFINE('_UE_BUTTON_SEND','Send');
DEFINE('_UE_BUTTON_SEND_USERNAME','Make me happy');
DEFINE('_UE_BUTTON_SEND_PASS','Generate');
DEFINE('_UE_BUTTON_SEND_USERNAME_PASS','Recover me, please!');
...
//unicycling.ru vars
DEFINE('_UE_UNICYCLES','Unicycles');
DEFINE('_UE_UNINUM','Total');
DEFINE('_UE_UNIINFO','Your setups');

//registration
//DEFINE('_UE_PENDING','Одноколёсный аккаунт ожидает подтверждения.'); - нет подтверждений
DEFINE('_UE_CONF_REG','Unicycling.ru. Registration complete.');
DEFINE('_UE_GENDER','Sex');