...
'View Facebook Profile'	=>	'Просмотреть свой профиль на Facebook',
'Logout of your Facebook account.'	=>	'Выйти из своего аккаунта на Facebook.',
'Sign out'	=>	'Выписаться',
'Login with your Facebook account.'	=>	'Войти на свой аккаунт Facebook.',
'Sign in'	=>	'Записаться',
'Unjoin this site'	=>	'Отсоединиться от этого сайта',
'Unauthorize this site from your Facebook account.'	=>	'Запретить этому сайту просмотр Вашего аккаунта Facebook.',
'Are you sure you want to unjoin %s?'	=>	'Вы действительно желаете отсоединиться от %s?'
));
...
'Login with your Twitter account.'	=>	'Войти на свой аккаунта на Twitter.'
));

// imagetoolbox messages needed for CB Team plugins
CBTxt::addStrings( array(
// 1 language string from imagetoolbox
'The file exceeds the maximum size of %s kilobytes'	=>	'Этот файл превосходит максимальный размер в %s килобайт.'
));
