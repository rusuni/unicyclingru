...
DEFINE('_UE_MEMBERSINCE','Зарегистрирован(а)');
DEFINE('_UE_LASTONLINE','В прошлый раз');
DEFINE('_UE_ONLINESTATUS','Статус нахождения на сайте');
DEFINE('_UE_ISONLINE','ГДЕ-ТО РЯДОМ');
DEFINE('_UE_ISOFFLINE','В РЕАЛЬНОСТИ');
DEFINE('_UE_PROFILE_TITLE','Страница профиля');
DEFINE('_UE_UPDATEPROFILE','Изменить профиль');
...
//Registration form
DEFINE('_UE_REG_COMPLETE_NOPASS','<div class="componentheading">И совсем не больно!</div>'
.'<p>Пароль выслан на почту.</p>'
.'<p>Ожидайте письмо во входящих (проверьте спам). Пароль подходит в поле для ввода пароля. Это ключ к сайту.</p>');
...
.'<p>Эл.письмо с дальнейшими указаниями о завершении регистрации было отправлено на вашу почту.</p>'
.'<p>Пожалуйста проверьте Вашу эл.почту (включая папку для спама) для завершения регистрации.</p>'
.'<p>Для отправки повторного письма попытайтесь войти на сайт с регистрационными данными.</p>');
...
DEFINE('_UE_REGISTER','Создать профиль');
...
//Beta 3 Build
DEFINE('_UE_NOLISTFOUND','Чтобы видеть список пользователей, зарегистрируйтесь!');
...
DEFINE('_UE_EMAILFORMWARNING','ВАЖНО:<ol>'
		...
		.'<li>Не забудьте подписать письмо.</li>'
		.'</ol>');
DEFINE('_UE_EMAILFORMSUBJECT','Тема:');
DEFINE('_UE_EMAILFORMMESSAGE','Текст:');
DEFINE('_UE_EMAILFORMTITLE','Отправить письмо на почту @%s');
...
DEFINE('_UE_SENTEMAILSUCCESS','Ваше письмо успешно отправлено!');
...
DEFINE('_UE_EMAILFOOTER','ВАЖНО: Письмо автоматически создано роботом сайта %s. Не надо на него отвечать. Робот не умеет принимать письма.');
...
if (!defined('_REGISTER_TITLE'))	DEFINE('_REGISTER_TITLE','Для завершения расскажите немного о себе.<br/>Подробности можно указать в профиле после создания.');
...
if (!defined('_SENDING_PASSWORD'))	DEFINE('_SENDING_PASSWORD','Мы сами придумаем пароль и отправим по адресу выше.<br />Можете сменить его после входа на сайт.');
...
if (!defined('_LOGIN_INCORRECT'))	DEFINE('_LOGIN_INCORRECT','Где-то ошибка. Пожалуйста, попробуйте еще раз.');
...
define('_UE_USERNAME_ALREADY_EXISTS',"Упс. В базе данных уже есть '%s'. Вход для клонов запрещён.");
define('_UE_USERNAME_DOESNT_EXISTS',"Имя пользователя '%s' свободно. Регистрируйте.");
define('_UE_CHECKING',"Устанавливаем связь с космосом...");
define('_UE_SORRY_CANT_CHECK',"Извините, сигнал застрял в плотных слоях атмосферы.");
...
DEFINE('_UE_REMINDER_NEEDED_FOR','Напомните мне, пожалуйста');
DEFINE('_UE_LOST__USERNAME','никнейм (имя пользователя)');
DEFINE('_UE_LOST__PASSWORD','пароль');
...
DEFINE('_UE_EMAIL_COULD_NOT_CHECK','Убедитесь в правильности адреса перед продолжением.');
DEFINE('_UE_EMAIL_COULD_NOT_CHECK_NEEDED','Нет ответного гудка. Проверьте написание, от этого зависит доступ к сайту.');
DEFINE('_UE_EMAIL_INCORRECT_CHECK','Существование ящика под сомнением. Пожалуйста, выберите другой или напишите администратору.');
DEFINE('_UE_EMAIL_INCORRECT_CHECK_NEEDED','Существование ящика под сомнением. Пожалуйста, выберите другой или напишите администратору. От этого зависит доступ к сайту.');
DEFINE('_UE_EMAIL_VERIFIED','Похоже, всё хорошо. Скоро узнаем результат.');
DEFINE('_UE_EMAIL_NOVALID','Мы не умеем доставлять письма на такой адрес.');
DEFINE('_UE_EMAIL_ALREADY_REGISTERED','Этот адрес эл.почты уже зарегистрирован. Доступ только для оригиналов.');
DEFINE('_UE_FIELDONPROFILE_SHORT','Поля, видимые всем в профиле');
DEFINE('_UE_FIELDNOPROFILE_SHORT','Поля <strong>не</strong> видимые в профиле. Для администрации.');
...
DEFINE('_UE_LOST_USERNAME_PASSWORD','Восстановить доступ');
DEFINE('_UE_LOST_USERNAME_OR_PASSWORD','Хорошо, что на уницикл не нужен логин или пароль!');
DEFINE('_UE_LOST_USERNAME_DESC','А этот текст где?');
DEFINE('_UE_LOST_USERNAME_ONLY_DESC','Сыграем в игру. Укажите адрес эл.почты, затем щелкните на кнопку "Сделать хорошо". Имя пользователя уйдёт письмом по адресу.');
DEFINE('_UE_LOST_PASSWORD_DESC','Ничего страшного. Укажите имя пользователя (никнейм) и адрес Вашей эл.почты, щелкните на кнопку "Сотворить чудо" и ищите пароль на почте. Используйте этот новый пароль для входа на сайт.');
DEFINE('_UE_LOST_USERNAME_PASSWORD_DESC','Случай тяжёлый. Сперва восстановим имя пользователя, а затем пароль. Для этого укажите адрес вашей эл.почты, затем щелкните на кнопку "Вспомнить всё". Имя пользователя уйдёт письмом по адресу. Далее восстановите пароль.');
DEFINE('_UE_BUTTON_SEND','Отправить');
DEFINE('_UE_BUTTON_SEND_USERNAME','Сделать хорошо');
DEFINE('_UE_BUTTON_SEND_PASS','Сотворить чудо');
DEFINE('_UE_BUTTON_SEND_USERNAME_PASS','Вспомнить всё');
...
DEFINE ('_UE_HI_NAME','Спасибо за участие, %s');
...
DEFINE ('_UE_MONTHS_1','Января');
DEFINE ('_UE_MONTHS_2','Февраля');
DEFINE ('_UE_MONTHS_3','Марта');
DEFINE ('_UE_MONTHS_4','Апреля');
DEFINE ('_UE_MONTHS_5','Мая');
DEFINE ('_UE_MONTHS_6','Июня');
DEFINE ('_UE_MONTHS_7','Июля');
DEFINE ('_UE_MONTHS_8','Августа');
DEFINE ('_UE_MONTHS_9','Сентября');
DEFINE ('_UE_MONTHS_10','Октября');
DEFINE ('_UE_MONTHS_11','Ноября');
DEFINE ('_UE_MONTHS_12','Декабря');
...
DEFINE('_UE_ENABLESPOOFCHECK_DESC','Выбирайте эту настройку если Вы желаете включить проверку спуффикса сессий (настоятельно рекомендуется, за исключением случаев, когда Вы испытываете трудности с закрытием сессий и ошибки куки, если они включены). По умолчанию этот параметр отключен ради большей стабильности и простоты использования интерфейса пользователя.');
...
//новые переменные уницикл.рф
//закладка "унициклы"
DEFINE('_UE_UNICYCLES','Унициклы');
DEFINE('_UE_UNINUM','Всего колёс');
DEFINE('_UE_UNIINFO','Сетапы');

//регистрация
//DEFINE('_UE_PENDING','Одноколёсный аккаунт ожидает подтверждения.'); - нет подтверждений
DEFINE('_UE_CONF_REG','Уницикл.рф. Теперь нас ещё больше.');
DEFINE('_UE_GENDER','Пол');