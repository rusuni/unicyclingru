...
'Resend Confirmations'	=>	'Отправить повторное подтверждение',
...
'Warning: %s entries in the users table without corresponding user_usergroup_map table rows.' => 'Предупреждение: в таблице пользователей содержится %s записей, которые не имеют соответствующих записей в таблице corresponding user_usergroup_map table rows.',
'user id: %s are missing in core_acl_aro table' => 'пользовательское id: %s отсутствует в таблице core_acl_aro',
'user id: %s are missing in user_usergroup_map table' => 'пользовательское id: %s отсутствует в таблице user_usergroup_map table',
...
'All users table rows have ACL entries in user_usergroup_map table.' => 'Все записи таблицы пользователей обладают записями ACL в таблице user_usergroup_map table.',
...
'All [tablename1] table rows have corresponding entries in [tablename2] table.' => 'Все [tablename1] строки таблицы имеют соответствующие записи в [tablename2] таблице.',
...
'Get Plugins' => 'Дополнительные плагины',
'Success' => 'Успех',
'Failed' => 'Провал',
'publish' => 'публиковать',
'unpublish' => 'не публиковать',
...
'Operation not allowed by the Permissions of your group(s).' => 'Операция не допускается вашей группой (ы).',
...
'All groups above that level will also have access to this tab.' => 'Все группы выше этого уровня также будут иметь доступ к этой вкладке.',
...
'Could not send email to %s of %s users out of %s emails to send' => 'Не удается отправить сообщение %s из %s пользователям из %s электронной почты для отправки',
'Just sent %s emails to following users:' => 'Просто отправлены %s письма на следующим пользователям',
'Still %s emails remaining to send.' => 'Все еще %s письма(ем) ожидает(ют) отправки.',
'%s emails could not be sent due to a sending error.' => '%s электронной почте не может быть отправлено из-за ошибки отправки.',
...
'Click here to see more CB Plugins (Languages, Fields, Tabs, Signup-Connect, Paid Memberships and over 30 more) by CB Team at joomlapolis.com' => 'Нажмите здесь для просмотра дополнительных болле 30 платных плагинов для CB на joomlapolis.com',
'Click here to see CB Directory listing hundreds of CB extensions at joomlapolis.com' => 'Нажмите здесь, чтобы посмотреть каталог расширений CB на joomlapolis.com',
'Click here to Check our CB listing on JED and find more third-party free add-ons for your website' => 'Нажмите здесь, чтобы проверить наш CB каталог на JED и найти там больше сторонних бесплатные дополнений для вашего сайта',
'Install New Plugin' => 'Установить новый плагин',
'Upload Package File' => 'Загрузить файл пакета',
'Maximum upload size: <strong>[filesize]</strong> <em>(upload_max_filesize setting in file [php.ini] )</em>' => 'Максимальный размер загрузки: <strong>[filesize]</strong> <em>(максимальный размер файла загрузки можно изменить в настройках файла [php.ini] )</em>',
...
'View Access Level' => 'Посмотреть уровень доступа',
'User Group to allow access to' => 'Группа пользователей для доступа к',
'Old deprecated method of Joomla 1.5, do not use here' => 'Старый устаревший метод для Joomla 1.5, не используйте здесь',
'Keep setting "-- Everybody --" and Use View Access Level above instead' => 'Храните настройки "-- все --" просмотр и использование уровеня доступа над',
'New method working in all Joomla and Mambo versions' => 'Новый метод работает во всех Joomla и Mambo версиях',
'Old Joomla [VERSION] method' => 'Старый Joomla [VERSION] метод',
'Only users which are in groups assigned to this View Access Level will see this tab.' => 'Только пользователи, которые находятся в группах назначены на этот уровень доступа и сможете посмотреть эту вкладку.',
'Only users which are in groups assigned to this View Access Level will see this list.' => 'Только пользователи, которые находятся в группах назначены на этот уровень доступа и сможете посмотреть список.',
'This method is kept for backwards compatibility but will be removed at next major Community Builder version.' => 'Этот метод поддерживается для обратной совместимости, но будет удален в следующей версии Builder Builder.',
'Use View Access Level above instead and set this Group setting to - "Everybody" -.' => 'Используйте просмотр уровня доступа "над",вместо этого и установите эту настройку для группы - "Everybody" -.',
