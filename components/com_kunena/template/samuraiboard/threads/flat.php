...
<table class="<?php echo isset ( $this->objCatInfo->class_sfx ) ? ' kblocktable' . $this->escape($this->objCatInfo->class_sfx) : ''; ?>" id="kflattable">
	<th>&nbsp;</th>
	<th>&nbsp;</th>
	<th><?php echo JText::_('COM_KUNENA_GEN_REPLIES'); ?></th>
	<th><?php echo JText::_('COM_KUNENA_GEN_HITS'); ?></th>
	...
	?>
		...
		?>">
			...
			<td class="kcol-mid kcol-ktopicviews">
				...
				<?php /*<span class="ktopic-views"> <?php echo JText::_('COM_KUNENA_GEN_HITS');?> </span> */?>
				<!-- /Views -->
			</td>
			...
			<td class="kcol-mid kcol-ktopiclastpost">
				<div class="klatest-post-info">
					...
					elseif ($this->topic_ordering == 'ASC') :
						...
						echo CKunenaLink::GetThreadPageLink ( 'view', intval($leaf->catid), intval($leaf->thread), $threadPages, intval($this->config->messages_per_page), '', intval($this->lastreply [$leaf->thread]->id) );
					else :
...
<?php 
	...
	echo $renderer->render('',$attribs, $block);*/
