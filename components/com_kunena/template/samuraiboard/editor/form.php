	...
	<tbody id="kpost-message">
		...
		<tr id="kpost-buttons" class="krow1">
			<td id="kpost-buttons" colspan="2">
				<?php /* <input type="submit" name="ksubmit" class="kbutton"
				value="<?php echo (' ' . JText::_('COM_KUNENA_GEN_CONTINUE') . ' ');?>"
				title="<?php echo (JText::_('COM_KUNENA_EDITOR_HELPLINE_SUBMIT'));?>" /> */?>
				
				<a class="readon readmore button" href="javascript:;" onclick="if (myValidate(document.postform)) document.postform.submit();" title="<?php echo (JText::_('COM_KUNENA_EDITOR_HELPLINE_SUBMIT'));?>"><span><?php echo (' ' . JText::_('COM_KUNENA_GEN_CONTINUE') . ' ');?></span></a>
				<a class="readon readmore button" href="javascript:window.history.back();" title="<?php echo (JText::_('COM_KUNENA_EDITOR_HELPLINE_CANCEL'));?>"><span><?php echo (' ' . JText::_('COM_KUNENA_GEN_CANCEL') . ' ');?></span></a>
				<?php /*
