						...
						<form action="<?php echo KUNENA_LIVEURLREL ?>" method="post" name="login">
							<div class="input">
								...
								<span>
									...
									<?php endif; ?>
									<?php /*<input type="submit" name="submit" class="kbutton" value="<?php echo JText::_('COM_KUNENA_PROFILEBOX_LOGIN'); ?>" /> */?>
									<a class="readon readmore button" href="javascript:;" onclick="document.login.submit();" title="<?php echo JText::_('COM_KUNENA_PROFILEBOX_LOGIN'); ?>"><span><?php echo JText::_('COM_KUNENA_PROFILEBOX_LOGIN'); ?></span></a>
