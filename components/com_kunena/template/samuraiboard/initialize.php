...
// New Kunena JS for samuraiboard template
// TODO: Need to check if selected template has an override
CKunenaTools::addScript ( KUNENA_DIRECTURL . 'template/samuraiboard/js/default-min.js' );
...
$cssurl = JURI::base() . "components/com_kunena/template/samuraiboard/css";
?>
<!--[if lte IE 7]>
