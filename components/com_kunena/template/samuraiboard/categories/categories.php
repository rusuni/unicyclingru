...
<div class="mod-rounded"><div class="box-t1"><div class="box-t2"><div class="box-t3"></div></div></div><div class="box-1"><div class="box-2"><div class="box-3">
	...
	<div class="kheader">
		<?php /*<span class="ktoggler"><a class="ktoggler close" title="<?php echo JText::_('COM_KUNENA_TOGGLER_COLLAPSE') ?>" rel="catid_<?php echo intval($section->id) ?>"></a></span> */?>
		<h2><?php //echo CKunenaLink::GetCategoryLink ( 'showcat', intval($section->id), $section->htmlCategoryIcon ) ?><span><?php echo CKunenaLink::GetCategoryLink ( 'listcat', intval($section->id), $this->escape($section->name), 'follow' ); ?></span></h2>
...
<table class="kblocktable<?php echo $htmlClassBlockTable ?>" id="kcat<?php echo intval($section->id) ?>">
	<th>&nbsp;</th>
	<th>&nbsp;</th>
	<th><?php echo JText::_('COM_KUNENA_GEN_TOPICS'); ?></th>
	<th><?php echo JText::_('Posts'); ?></th>
	<th><?php echo JText::_('COM_KUNENA_GEN_LAST_POST'); ?></th>
	...
	?>
		...
		<?php endif; ?>
			...
			<td class="kcol-mid kcol-kcattopics">
				...
				<?php /*<span class="kcat-topics"><?php echo JText::_('COM_KUNENA_GEN_TOPICS');?></span> */?>
				<!-- /Number of Topics -->
			</td>
			...
			<?php /*<span class="kcat-replies"><?php echo JText::_('COM_KUNENA_GEN_REPLIES');?> </span> */?>
			<!-- /Number of Replies -->
			</td>
