			...
			<td class="kprofileboxcnt">
				...
				<ul class="kprofilebox-welcome">
					...
					<form action="<?php echo KUNENA_LIVEURLREL ?>" method="post" name="login">
						<?php /*<input type="submit" name="submit" class="kbutton" value="<?php echo JText::_('COM_KUNENA_PROFILEBOX_LOGOUT'); ?>" /> */?>
						<a class="readon readmore button" href="javascript:;" onclick="document.login.submit();" title="<?php echo JText::_('COM_KUNENA_PROFILEBOX_LOGOUT'); ?>"><span><?php echo JText::_('COM_KUNENA_PROFILEBOX_LOGOUT'); ?></span></a>
